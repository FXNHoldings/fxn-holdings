 ...
 * Design: Kinetic Blueprint — dark footer with blueprint grid, gold accents
 */
...
export default function Footer() {
  return (
    <footer className="relative bg-[oklch(0.14_0.035_240)] border-t border-white/10 overflow-hidden">
      ...
      <div className="relative container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span className="font-['Space_Grotesk'] font-700 text-white text-xl leading-none">
                  FXN<span className="text-[oklch(0.62_0.2_220)]"> Holdings</span>
                </span>
                <p className="mono-label text-[oklch(0.55_0.02_240)] text-[10px] leading-none mt-0.5">
                  LIMITED · REGISTERED IN ENGLAND & WALES
                </p>
              </div>
            </div>
            <p className="text-[oklch(0.65_0.02_240)] text-sm leading-relaxed max-w-sm mb-6">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 text-[oklch(0.65_0.02_240)] text-sm">
          ...
          {/* Portfolio Links */}
          <div>
            <h4 className="font-['Space_Grotesk'] font-600 text-white text-sm mb-5 flex items-center gap-2">
            ...
            <ul className="flex flex-col gap-3">
              {portfolioLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href}>
                    <span className="text-[oklch(0.65_0.02_240)] text-sm hover:text-[oklch(0.62_0.2_220)] transition-colors flex items-center gap-1.5 group">
          ...
          <div>
            ...
            <div className="mt-8">
              <h4 className="font-['Space_Grotesk'] font-600 text-white text-sm mb-3 flex items-center gap-2">
                <span className="w-4 h-px bg-[oklch(0.75_0.17_75)]" />
                Legal
              </h4>
              <ul className="flex flex-col gap-2">
                <li>
                  <span className="text-[oklch(0.65_0.02_240)] text-sm hover:text-[oklch(0.62_0.2_220)] transition-colors cursor-pointer">
                    Privacy Policy
                  </span>
                </li>
                <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="mono-label text-[oklch(0.45_0.02_240)] text-xs">
